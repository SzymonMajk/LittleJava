...
/**
 * Wersja programu z uzyciem watkow tworzonych recznie na bazie Runnable.
 */
public class FactorialCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		System.out.println("Wersja 3 - czas wykonywania obliczen: " + time
				/ 1000000 + " [ms]");
	}
	...
	private static void processFactorials(List<String> factorialsToCalculate)
		...
		for (String ln : factorialsToCalculate) {
			...
			// utworzenie obiektu implementujacego Runnable
			FactorialRunnable factorialRunnable = new FactorialRunnable(n);
			
			// utworzenie watka na babzie Runnable
