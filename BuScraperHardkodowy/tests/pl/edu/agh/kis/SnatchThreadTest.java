...
public class SnatchThreadTest {
	 ...
	 */
	@Test
	public void testRunOkulickiego() throws IOException, InterruptedException {
		...
		//Przygotowanie danych testowych
		File testFile = new File("Tests/AnaliseHTMLPage611Okulickiego");
		if(!testFile.exists())
		{
			fail("Brak ¿adanego pliku testowego");
		}
		...
		File expectedFile = new File("Tests/OkulickiegoResults");
		File gotFile = new File(testRoot+"993OdTestDoKierunek/Okulickiego");
		File buStops = new File(testRoot+"buStops/Okulickiego");
		File testDataFolder = new File(testRoot+"buStops").getParentFile();
